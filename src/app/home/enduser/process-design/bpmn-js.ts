...
import _CamundaPropertiesProvider from 'bpmn-js-properties-panel/lib/provider/camunda';
...
export const OriginalPropertiesProvider = _CamundaPropertiesProvider;
